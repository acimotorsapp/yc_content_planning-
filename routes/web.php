...
Route::get('/dashboard', [CalendarEventController::class, 'dashboard'])
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/admin/events/brand', [CalendarEventController::class, 'adminBrand'])->name('admin.events.brand');
    Route::get('/admin/events/service', [CalendarEventController::class, 'adminService'])->name('admin.events.service');
    ...
    Route::get('/admin/budget', [CalendarEventController::class, 'budgetProvision'])->name('admin.budget.index');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/events/brand', [CalendarEventController::class, 'storeBrand'])->name('events.brand.store');
    Route::post('/events/service', [CalendarEventController::class, 'storeService'])->name('events.service.store');
    ...
    Route::patch('/events/board/reorder', [CalendarEventController::class, 'reorderBoard'])->name('events.reorder_board');
    ...
    Route::patch('/events/{event}/title', [CalendarEventController::class, 'updateTitle'])->name('events.update_title');
    ...
    Route::patch('/events/{event}/feedback', [CalendarEventController::class, 'updateFeedback'])->name('events.update_feedback');
    Route::patch('/events/{event}/reschedule', [CalendarEventController::class, 'reschedule'])->name('events.reschedule');
